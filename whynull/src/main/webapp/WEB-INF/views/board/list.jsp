                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${list}" var="board">
                        <tr>
                            ...
                            <td class="text-start px-2"><a class="read" href="/whynull/board/read?boardNum=<c:out value='${board.board_num}'/>&postNum=<c:out value='${board.post_num}'/>" style="text-decoration:none; color:black;"><c:out value="${board.post_title}"/> [<c:out value="${board.reply_count}"/>]</a></td>
